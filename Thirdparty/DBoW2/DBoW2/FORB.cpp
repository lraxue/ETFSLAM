                         ...
                         FORB::TDescriptor &mean)
    {
        ...
        else
        {
            ...
            for (size_t i = 0; i < descriptors.size(); ++i)
            {
                ...
                const unsigned char *p = d.ptr < unsigned
                char > ();
            ...
            unsigned char *p = mean.ptr < unsigned
            char > ();
...
// --------------------------------------------------------------------------
    ...
    {
        stringstream ss;
        const unsigned char *p = a.ptr < unsigned
        char > ();
...
// --------------------------------------------------------------------------
                        ...
                        cv::Mat &mat)
    {
        ...
        for (size_t i = 0; i < N; ++i)
        {
            ...
            const unsigned char *desc = descriptors[i].ptr < unsigned
            char > ();
...
// --------------------------------------------------------------------------
                       ...
                       cv::Mat &mat)
    {
        ...
        unsigned char *p = mat.ptr < unsigned
        char > ();

        for (size_t i = 0; i < descriptors.size(); ++i, p += 32)
        {
            const unsigned char *d = descriptors[i].ptr < unsigned
            char > ();
            std::copy(d, d + 32, p);
        }
